    ...
    <tiles:putAttribute name="body"> <!--main content start-->
        <div class="content" data-ng-app="myApp">
            ...
            <div class="main-content"  data-ng-controller="MyController">
                <div class="row">
                    <div class="col-md-12" >
                        <form method="POST" ng-submit="saveTeacher()"
                        ...
                        <jsp:include page="/WEB-INF/pages/user/loginInfo.jsp"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input ng-model="user.designation" class="form-control" required="true"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <datepicker date-format="dd/MM/yyyy">
                                        <input ng-model="user.dateOfJoin" class="form-control" name="joiningDate"
                                               id="joiningDate"/>
                                    </datepicker>
