                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form:form method="POST" commandName="vacation" action="${appBaseUrl}/private/addUpdateVaction.web" cssClass="form-horizontal form-border">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Rrom</label>
                                    <div class="col-sm-6">
